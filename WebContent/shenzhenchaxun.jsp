...
<style>
        body { 
            background: url("img/深圳.jpg") center top / cover no-repeat fixed;
	 ...
	 if(rs.next()){
		 if(rs.getString("cfd").equals("深圳"))
		 {
			...
			out.println("</tr>");
			 ...
			 out.print("<script language='javascript'>alert('不属于深圳站！');history.back();</script>"); 
		 }
