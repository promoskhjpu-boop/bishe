...
<hr> 
    ...
    <table border="1" align="center" class="express-table">
		<tr>
			<th>快递编号</th>
			<th>姓名</th>
			<th>手机号</th>
...
System.out.print("Error getConnection,不能连接数据库");
 ...
 try{
	 ...
	 String sql="select * from "+tableName+" where number ="+n;
	 rs=st.executeQuery(sql);
	 if(rs.next()){
		 if(rs.getString("kd").equals("ems"))
		 {
			out.println("<tr>");
			...
			out.println("<tr>");
			 ...
			 out.print("<script language='javascript'>alert('不属于ems快递！');history.back();</script>"); 
		 }
